...
/**
 * Android page curl is just a view that simulates a 2D page curl effect using
 * the android canvas. This makes is usable for quite all android versions and
 * eliminates the need for OpenGL in this case.
 * <p>
 * For more information about the project visit the projects site:
 * http://code.google.com/p/android-page-curl/
 * 
 * @author Moritz 'Moss' Wundke (b.thax.dcg@gmail.com)
 * 
 */
public class AndroidPageCurlActivity extends Activity implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * // Run as full-screen requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	public void onClick(View v) {
		...
		default:
			Toast toast = Toast.makeText(this,
					"Do I missed the button you clicked?", Toast.LENGTH_LONG);
			toast.show();
			break;
		}
